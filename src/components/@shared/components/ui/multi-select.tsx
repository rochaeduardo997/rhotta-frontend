...
import {
  ...
  CommandList,
  CommandSeparator
} from '@src/components/@shared/components/ui/command';
...
const multiSelectVariants = cva('m-1 transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110', {
  ...
  variants: {
    variant: {
      ...
      destructive: 'text-destructive-foreground border-transparent bg-destructive hover:bg-destructive/80',
      inverted: 'inverted',
            ...
            <CommandList>
              ...
              <CommandGroup>
                ...
                {options.map(option => {
                  ...
                  return (
                    <CommandItem key={option.value} className="cursor-pointer" onSelect={() => toggleOption(option.value)}>
                      <div
                        className={cn(
                          'mr-2 flex h-4 w-4 items-center justify-center rounded-sm border border-primary',
